...
import torch
import sys
sys.path.append('C:\\Users\\10167\\Desktop\\lib\\code\\AirTransformer')
...
def get_config():
    ...
    parser.add_argument('--stochastic_flag', type=str_to_bool,
                        default=False, help='whether to use stochastic temporal transformer')
    ...
    """ args.graph_pkl = 'data/sensor_graph/adj_mx_{}.pkl'.format(
        args.dataset.lower()) """
    args.graph_pkl = 'data/sensor_graph/adj_mx_ft_new.pkl'.format(
        args.dataset.lower())
